...
public class Api {
    ...
    public Observable appVersion() {
        return mApiService.appVersion().compose(RxUtils.ioMain());
    }
    ...
    public Observable search(String content, int page, int pagesize) { return mApiService.search(content, page, pagesize).compose(RxUtils.ioMain()).map(new HttpResultFunc());}
    ...
    public Observable feedBack(String userId, String msg, int feedbackType) { return mApiService.feedBack(userId, msg, feedbackType).compose(RxUtils.ioMain());}
    ...
    public Observable postReply(PostReplyRequest request) {return mApiService.postReply(request.getRoom_id(), request.getUser_id(), request.getContent(), true).compose(RxUtils.ioMain());}
