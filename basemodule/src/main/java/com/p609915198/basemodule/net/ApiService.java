...
import static com.p609915198.basemodule.net.UrlConstant.GIVE_GIFT;
...
public interface ApiService {
    ...
    @POST(SEARCH)
    Observable<HttpResult<List<SearchResponse>>> search(@Query("content") String content);
    ...
    @POST(POST_REPLY)
    Observable<HttpResult<String>> postReply(@Body PostReplyRequest request);
    ...
    @POST(GIVE_GIFT)
    Observable<HttpResult> giveGift(@Body GiveGiftRequest request);
