package com.p609915198.fwb.app.manager;
...
public class MediaSessionManager {
    ...
    public void updateMetaData(Audio music) {
        if (music == null) {
        ...
        MediaMetadataCompat.Builder metaData = new MediaMetadataCompat.Builder()
                .putString(MediaMetadataCompat.METADATA_KEY_TITLE, music.getAudio_name());
//                .putString(MediaMetadataCompat.METADATA_KEY_ARTIST, music.get())
...
//                );
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            metaData.putLong(MediaMetadataCompat.METADATA_KEY_NUM_TRACKS, AppConfig.getAudioCache().size());
        }
